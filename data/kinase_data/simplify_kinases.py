...
kinase_category_mapping = {
    ...
    "BUB1": "Other BUB BUB1	",
    "BVR": "",  # 3
    "CAK": "CMGC CDK CDK7 CDK7",  # kinase subunit of cak is almost identical to cdk7: https://pubmed.ncbi.nlm.nih.gov/15876871/
    "CAMK": "CAMK",
    "CAMK1": "CAMK",
    "CaMK1D": "CAMK",
    "CAMK2": "CAMK",
    ...
    "CDC42BP": "AGC DMPK GEK MRCKb",  # https://www.uniprot.org/uniprotkb/Q9Y5S2/entry
    ...
    "CDK9": "CMGC CDK",
    "CDKA": "CMGC CDK",
    "Chak1": "",  # 6 entries, TRPM 7
    "CHK": "CAMK",
    "CHK1": "CAMK CAMKL CHK1 CHK1",
    "CHK2": "CAMK RAD53 CHK2",
    "CK": "",  # Ambiguous CK1, CK2 in different groups
    "CK1": "CK1 CK1",
    "CK2": "Other CK2",
